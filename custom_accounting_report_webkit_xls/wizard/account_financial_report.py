...
class AccountReportBalanceSheetWizard(orm.TransientModel):
    ...
    def check_report(self, cr, uid, ids, context=None):
        if context is None:
            context = {}
        res = super(AccountReportBalanceSheetWizard, self).check_report(cr, uid, ids, context=context)
        data = {}
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        if context.get('xls_export'):
            ...
            data['form'].update({'account_ids':False})
...
AccountReportBalanceSheetWizard()
